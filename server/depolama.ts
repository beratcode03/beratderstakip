...
// PostgreSQL veritabanı bağlantısı - try-catch ile güvenli başlatma
let sqlConnection: any = null;
let db: any = null;

// DOSYA TABANLI DEPOLAMA AKTİF - PostgreSQL devre dışı
// Replit ortamında dosya tabanlı depolama kullanıyoruz
