...
export function DashboardSummaryCards() {
  ...
  const calculateNetAverages = () => {
    ...
    // Checkbox işaretli (çözülmüş) DENEME HATALARI hesapla
    ...
    try {
      ...
      if (savedCompletedExamErrors) {
        const completedExamErrorsArray = JSON.parse(savedCompletedExamErrors);
        solvedExamErrorsCount = completedExamErrorsArray.length;
      }
    } catch (error) {
      console.error('Error calculating solved exam errors:', error);
    }
    
    return { tytAvg: tytAvg.toFixed(1), aytAvg: aytAvg.toFixed(1), examCount: last5Exams.length, solvedExamErrorsCount };
  };
              ...
              <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-4 backdrop-blur-sm border border-emerald-200/30 dark:border-emerald-700/30">
                <div className="flex items-center justify-between mb-3">
                  <div>
                    ...
                    <div className="text-sm font-medium text-emerald-700 dark:text-emerald-300">Düzeltilen Deneme Hataları</div>
                  </div>
              ...
              <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-4 backdrop-blur-sm border border-red-200/30 dark:border-red-700/30">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <div className="text-sm font-medium text-red-700 dark:text-red-300">Toplam Çözülen Hata</div>
                  </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-4 backdrop-blur-sm border border-green-200/30 dark:border-green-700/30">
                  <div className="text-center">
                    ...
                    <div className="text-sm font-medium text-green-700 dark:text-green-300 mb-2">Toplam Doğru</div>
                    <div className="w-full bg-green-200/50 dark:bg-green-900/40 rounded-full h-3 mt-2 overflow-hidden">
                      <div 
                    ...
                    <div className="text-xs font-medium text-green-700 dark:text-green-300 mt-2">
                ...
                <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-4 backdrop-blur-sm border border-red-200/30 dark:border-red-700/30">
                  <div className="text-center">
                    ...
                    <div className="text-sm font-medium text-red-700 dark:text-red-300 mb-2">Toplam Yanlış</div>
                    <div className="w-full bg-red-200/50 dark:bg-red-900/40 rounded-full h-3 mt-2 overflow-hidden">
                      <div 
                        className="bg-gradient-to-r from-red-500 to-red-600 h-3 rounded-full transition-all duration-1000 shadow-sm"
                        style={{ width: `${questionStats.totalQuestions > 0 ? (questionStats.totalWrong / questionStats.totalQuestions) * 100 : 0}%` }}
                      ></div>
                    </div>
                    <div className="text-xs font-medium text-red-700 dark:text-red-300 mt-2">
